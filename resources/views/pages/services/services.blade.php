            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="{{ route('services.list') }}">/</a></li>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <a href="course-details.html">
                                        <img src="{{ asset('/assets/img/courses/5.jpg') }}" alt="Thumb">
                                    </a>
                                </div>
                                <div class="info">
                                    <h4><a href="{{ route('services.show', $service) }}">{{ $service->name }}</a></h4>
                                    <p>
                                        {{ substr($service->description, 0, 250) }}
                                    </p>
